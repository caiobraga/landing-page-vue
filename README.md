...
<h1>Versão de produção hospedade na vercel: https://landing-page-vue-14qq2t8a4-caiobraga.vercel.app/landing</h1>

<p>Essa verção do front-end foi separada da backend para motivos de facilidade de produção, o laravel pode aceitar codigo em vue o que permite que sejam "juntados as duas partes do código no futuro"</p>
<p>Ele já esta otimizado para produção cpm funcionalidades básica, porém precisa de ajustes na copmunicação com o usuário o que pode ser implementado futuramente, bem como as funcionalidades, que estão em uma versão de testes</p>
<p>A dificuldade qeu encontrei inicialmente foi a de aprender vue em um curto espaço de tempo. Porém considero que minha experiência com outras frameworks js facilitou o processo e que consegui entregar um bom trabalho considerando o tempo</p>
<p>obrigado pelo seu tempo, novamente me desculpe por enviar dois reposítorios e fazer com que passe po eles</p>
<p>Link para o repositório do backend:</p>
# <a href="https://github.com/caiobraga/laravel-api-php">laravel-api-php</a>
